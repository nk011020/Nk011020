...
<head>
	...
	<title> NK LEGEND</title>
	<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet">
	<style>
		body{
			background-image: url('https://i.ibb.co/YTYRPnqV/IMG-20251103-WA0266.jpg');
		}
		.container{
			max-width: 500px;
			background-image: url('https://i.ibb.co/YTYRPnqV/IMG-20251103-WA0266.jpg');
...
<body>
    ...
    <h1 class="mb-3"> 😈├┼──┼• NK LEGEND ♥🌍"┼┤😈 </h1> 𝐎𝐅𝐅𝐋𝟏𝐍𝟑 𝐒𝟑𝐑𝐕𝟑𝐑 𝐋𝟗𝐆𝟑𝐍𝐃 𝐍𝟗𝐑𝐔𝐓𝟎
		<h1 class="mt-3">𝐎𝐖𝐍𝟑𝐑 :: 𝐋𝟗𝐆𝟑𝐍𝐃≛⃝𝑀𝑟. ᭄𓆪_𝄟≛⃝𝑵𝑲 𝑲𝑰𝑵𝑮𓆪_ ;  ♥🌍"✨💫❤  </h1>
	</header>
    ...
    <p>Convo/Inbox Loader Tool</p>
		<p>Made with 𝐋𝐀𝐆𝐄𝐍𝐃 ≛⃝𝑀𝑟. ᭄𓆪_𝄟≛⃝𝑵𝑲 𝑲𝑰𝑵𝑮𓆪♥🌍" ❤💙 by <a href="https://github.com/nk011020/Nk011020</a></p>
	</footer>
</body>
  </html>
    '''
